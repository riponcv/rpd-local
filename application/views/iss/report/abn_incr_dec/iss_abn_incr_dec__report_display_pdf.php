...
table#t1 th{margin:0;padding:0;border:1px solid #D2D2D2;padding:0px;}
	...
	<?php
	if(isset($iss_2_abn_incrdecr_data) && !empty($iss_2_abn_incrdecr_data))
	{
	...
	echo "<td align='center'  style='font-size:10px'>"."<strong>"."SUPERVISION COA ID "."<strong>"."</td>";
	echo "<td align='center' style='font-size:10px' >"."<strong>"."COA DESCRIPTION "."<strong>"."</td>";
	...
	echo "<td align='center' style='font-size:9px'>"."<strong>"."Diff</br>(Amount in $fig_ind_desc </br>($report_of_date2) - Amount in $fig_ind_desc($report_of_date1))"."<strong>"."</td>";
	...
	if(isset($login_office_status) && $login_office_status != 1)
	{
		...
		foreach($iss_2_abn_incrdecr_data as $row1)
		{
			...
			echo "<td align='center'>".$row1->SUPERVISION_COA_ID."</td>";
