...
<p>
  <?php
  echo form_open('rpd/omis_zn_report_interface_all/true');
  $date_var=$date1;
  ...
  foreach($br_name as $br)
   {
	...
	/*
	 echo "<table align=\"center\">"; 
		 ...
		 echo "</tr>";
		 echo "<tr>";
		 echo "<th style='font-size:11px;'>"."Report of"."</th>";
		 echo "<th style='font-size:11px;'>".$date11."</th>";
		 echo "<th style='font-size:11px;'>"."Printed on"."</th>";
		 echo "<th style='font-size:11px;'>".$var_today."</th>";
		 echo "</tr>";
	...
	echo "<th style='font-size:12px;'>"."Area Office"."</th>";
	echo "<th style='font-size:12px;'>".$data_br."</th>";
	echo "</tr>";
