...
<table align="center">
  <tr>
    <td align="center" style="font-size:20px;"><?php 
    echo isset($caseDesc[0]->lmcc_cc_desc_l3)?$caseDesc[0]->lmcc_cc_desc_l3:'';
    ?> Information</td>
        ...
        <table  class="" border="1">
          ...
          <?php 
              foreach($dataLaws as $lawAll){ ?>
                  <tr>
                      <td><?php echo isset($lawAll->lml_lawer_name)?$lawAll->lml_lawer_name:'';
                      echo ",";
                      echo isset($lawAll->lml_lawer_mobile)?$lawAll->lml_lawer_mobile:'';
                      ?></td>
                      <td><?php //echo isset($lawAll->lml_lawer_mobile)?$lawAll->lml_lawer_mobile:'';?></td>
                  </tr>
          <?php  } ?>
        </table> 
        <?php }?>
...
<?php 
    ...
    echo form_open('lms/lms_0002_report_details/1');
