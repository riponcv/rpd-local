    ...
    */
    ...
    function fetch_part_b_f_data($office_id=0, $month1='', $year1='', $month2='', $year2=''){
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            '30910', '31000', '31100', '31200', '31300', '31400', '31500', '31600', '31700', '31800','31900') THEN convert(money, amount) ELSE NULL END) AS 'whole_br_expenditure_pl'
                FROM [db_mis_RBA].[dbo].[$next_pl] where bcode not in ('0931', '0932', '0933', '0934')
            ) fw, 
            (
                SELECT 
            ...
            '30910', '31000', '31100', '31200', '31300', '31400', '31500', '31600', '31700', '31800','31900') THEN convert(money, amount) ELSE NULL END) AS 'br_expenditure_pl'
                FROM [db_mis_RBA].[dbo].[$next_pl]  where bcode='$office_id'
            ) fb");
    ...
    function fetch_part_b_e_data($office_id=0, $month1='', $year1='', $month2='', $year2=''){
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            SELECT 
                ...
                FROM [db_mis_RBA].[dbo].[$next_omis]
                WHERE dd_end_dt = (select a.om_dat_date from 
                (select * from [db_mis_RBA].[dbo].[om_entry_date] 
                ...
                from [db_mis_RBA].[dbo].[om_entry_date] 
                WHERE left(convert(varchar(10), om_dat_date, 112), 4) = $yr2 and 
    ...
    function fetch_part_b_c_data($office_id=0, $month1='', $year1='', $month2='', $year2=''){
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            (
                ...
                FROM [db_mis_RBA].[dbo].[$nextDsa] where bcode not in (0931,0932,0933,0934)
            ) cwaff, 
            (
                SELECT 
                ...
                FROM [db_mis_RBA].[dbo].[$nextDsa] where bcode='$office_id'
            ) cbaff, 
            (
            SELECT 
            ...
            SELECT 
                ...
                FROM [db_mis_RBA].[dbo].[$next_backAff] where bcode not in (0931,0932,0933,0934)
            ) cwaffback,
            (
            SELECT 
                ...
                FROM [db_mis_RBA].[dbo].[$next_backAff] where bcode='$office_id'
            ) cbaffback");
    ...
    function fetch_part_b_b_data($office_id=0, $month1='', $year1='', $month2='', $year2=''){
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            FROM [db_mis_RBA].[dbo].[$next_iss] where BRANCH_ID = (SELECT '12'+bbbrcode FROM [Db_DP_Collection_mgr].[dbo].[allinformation] where brcode='$office_id')
            )bbiss,
            (
            SELECT 
    ...
    function fetch_part_b_a_data($office_id=0, $month1='', $year1='', $month2='', $year2=''){
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            (
            SELECT 
            SUM(convert(money, amount)) AS 'whole_deposit' FROM [db_mis_RBA].[dbo].[$nextDsa] 
            where LEFT(sub_head, 3)='002' AND bcode not in (0931, 0932, 0933, 0934)
            )awaff,
            (
            SELECT 
            SUM(convert(money, amount)) AS 'br_deposit' FROM [db_mis_RBA].[dbo].[$nextDsa] 
    ...
    function fetch_part_a_h_data($office_id=0, $month1='', $year1='', $month2='', $year2='')
    {
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            JOIN (SELECT BRANCH_ID, 
                ...
                FROM [db_mis_RBA].[dbo].[$pre_iss] GROUP BY BRANCH_ID 
            ...
            JOIN (SELECT BRANCH_ID, 
                ...
                FROM [db_mis_RBA].[dbo].[$next_iss] GROUP BY BRANCH_ID 
    ...
    function fetch_part_a_g_data($office_id=0, $month1='', $year1='', $month2='', $year2=''){
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            $data['observation_regul_aud_comp'] = "Compliance of Regular Audit Objections";
            ...
            $data['grth_reg_audit_obj_comp'] = $result_partg[0]['grth_regular_audit_obj_complia'];
    ...
    function fetch_part_a_f_data($office_id=0, $month1='', $year1='', $month2='', $year2=''){
        ...
        if($month1 != '' && $year1 !='' && $month2 !='' && $year2 !=''){
            ...
            FROM [db_mis_RBA].[dbo].[$pre_backpage] 
                GROUP BY bcode
         ...
         '1070505', '1070506', '1070507', '1070508') THEN convert(money, amount) ELSE 0 END) AS 'next_susOther',
          SUM(CASE WHEN scode  IN ('1070501') THEN convert(money, amount) ELSE 0 END) AS 'next_sundryDeb',
            ...
            FROM [db_mis_RBA].[dbo].[$next_backpage] 
                GROUP BY bcode
