...
<p>
	...
	echo "<tr>";
	echo "<td width='50'>"."<strong>"."SL. No "."<strong>"."</td>";
	echo "<td align='left' width='150'>"."<strong>"."HEADS OF ACCOUNTS "."<strong>"."</td>";
	echo "<td align='left' >"."<strong>"."Accounts "."<strong>"."</td>";
	echo "<td align='left' width='25'>"."<strong>"."Telg. Code "."<strong>"."</td>";
	echo "<td align='centers' width='100'>"."<strong>"."Amount in Taka"."<strong>"."</td>";
	echo "</tr>";
	$data_amt = array();
	$amt_count=0;
	...
	foreach($records2 as $row1)
	{
		...
		if($count==20)
		{
			echo "<tr><td colspan='4'>"."<strong>"."Total Deposits (Exclude B/P) [1-19]"."<strong>"."</td>";
			echo '<td align="right">'.'<strong>'.number_format($dep_total_ex_bp,2).'<strong>'.'</td></tr>';
		}
		if($count==23)
		{
			echo "<tr><td colspan='4'>"."<strong>"."Total Deposit (Including BP) [1-22]"."<strong>"."</td>";
			echo '<td align="right">'.'<strong>'.number_format($weekly_dep,2).'<strong>'.'</td></tr>';
			...
			echo '<td align="right">'.'<strong>'.number_format($set_value,2).'<strong>'.'</td>';
			echo "</tr>";
		}
		if($count==32)
		{
            echo "<tr><td colspan='3'>"."<strong>"."Deposit in Foreign Currency (Excluding NFCD) [15-17]"."<strong>"."</td>";
            echo "<td><strong>YY</strong></td>";
			echo '<td>'.'<strong>'.number_format($weekly_dep_fc,2).'<strong>'.'</td></tr>';
		}
		if($count==42)
		{
			echo "<tr><td colspan='2'>"."<strong>"."Total Advances in Bangladesh [33-41]"."<strong>"."</td>";
			echo "<td><strong>(iv) Total Advances</strong></td>";
			echo "<td><strong>CC</strong></td>";
			echo '<td align="right">'.'<strong>'.number_format($weekly_adp,2).'<strong>'.'</td></tr>';
			$set_value=0;
		...
		if($count==53)
		{
			echo "<tr><td colspan='3'>"."<strong>"."Total Cash-in-Hand [42-52]"."<strong>"."</td>";
			echo "<td><strong>PP</strong></td>";
			echo '<td align="right">'.'<strong>'.number_format($weekly_cash,2).'<strong>'.'</td></tr>';
			$set_value=0;
