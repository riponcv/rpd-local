    ...
    jQuery(document).ready(function() {
        ...
        {
            control_misd_0042_report_form(report_option_selector);
        }
    })
    </script>
       
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Head Account/Single Account Comparisn Report</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('report/misd_0042_report_details','id="misd_0042_search_form"');
    ...
    echo '<select name="report_option_selector" id="report_option_selector" onchange="control_misd_0042_report_form(this.value)">';
   ...
   <table border="1" style="margin-top: 50px;display: none;" id="search_form_table">
    ...
    <td>
        ...
        echo '<option value="">Select 1st Date</option>';
    ...
    <td>
        ...
        echo '<option value="">Select 2nd Date</option>';
        if(isset($wp_date) && !empty($wp_date))
        {
             foreach($wp_date as $row)
        	{
    ...
    <td COLSPAN="4"><input type="text" size="60px" name="search_text" id="search_text" value="" onkeyup="fetch_br_ao_do_report(this.value)"/></td>
    </tr>
    ...
    <td COLSPAN="4"><input type="radio" name="head_account_radio" value="1" onchange="manage_group_subgroup_option(1)" />Head Account&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="head_account_radio" value="2" onchange="manage_group_subgroup_option(2)" />Single Account</td>
    </tr>
    ...
    <td COLSPAN="4">
    <input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_misd_0042(this.value)"/>
    <input type="button" name="save_report_as_pdf" id="save_report_as_pdf" value="Save Report As PDF" style="background-color: #FF9900;" onclick="check_search_form_misd_0042(this.value)"/>
    </td>
    </tr>
