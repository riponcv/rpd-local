    ...
    jQuery(document).ready(function() {
        ...
        {
            control_misd_0009_report_form(report_option_selector);
        }
    })
    </script>
       
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Yearly Position</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('report/misd_0009_report_details','id="misd_0009_search_form"');
	echo '<div id="report_option_div" style="margin-top:50px">';
    echo '<font style="color:brown;font-weight: bold;">Yearly Position For: </font>';
    ...
    echo '<select name="report_option_selector" id="report_option_selector" onchange="control_misd_0009_report_form(this.value)">';
   ...
   <table border="1" style="margin-top: 50px;display: none;" id="search_form_table">
    ...
    <td COLSPAN="3">
    <input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_misd_0009(this.value)"/>
    <input type="button" name="save_report_as_pdf" id="save_report_as_pdf" value="Save Report As PDF" style="background-color: #FF9900;" onclick="check_search_form_misd_0009(this.value)"/>
    </td>
    </tr>
