...
// echo "<pre>";
// print_r($lmseditDatas);
// echo "</pre>";
$attribute = '';
?>
    <div class="basic_info_content">
    <?php 
        $attributesForm = array('name' => 'lmsBasicEditpkForm', 'id'=>'lms_basic_search_fk_form_view');
        echo form_open_multipart('lms/lms_fkeep_entry_details_view', $attributesForm);
    ?>
    <div class="header-info text-center">
        <h4>Search for Edit File Kepper Information </h4>
    </div>
    <table class="">
        <tr>
            <td><label for="tracNoFK">Trac No.</label></td>
            <td>
            <div class="form-group">
            <select name="tracNoE" class="choseSelect tracNoC" id="tracNoFK" style="">
            ...
            <td>
            <div class="form-group">
                <input type="button" class="btn btnSave saveBtn" value="Search" <?php echo $attribute; ?> onclick="lms_fk_view_search(this.value)"/>            
            </div>
            </td>                    
        </tr>
    </table>
    ...
    <table class="table table-sm table-borderless">
        ...
        <?php foreach($lmseditDatas as $lmseditData) {?>
            <tr>
                <td><?php 
                    echo anchor('lms/lms_fkeep_entry_details_view/'.$lmseditData->lb_tran_no, $lmseditData->lb_tran_no, 'title="Edit"');
                ?>
                </td>
