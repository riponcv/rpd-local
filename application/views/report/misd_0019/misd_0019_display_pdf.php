...
<?php if(isset($previous_value['report_option_selector']) && $previous_value['report_option_selector']==5){ ?>
body
{
font-size:small;
}
...
<table style="margin-left: 845px;"><tr><td>Amount in Crore</td></tr></table>
<table border="1" style="border-collapse:collapse; margin-left:-40px" id="t1" align="center">
<tr>
