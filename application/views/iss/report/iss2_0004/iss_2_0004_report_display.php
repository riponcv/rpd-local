...
<?php
   ...
   if(isset($iss_2_0004_data) && count($iss_2_0004_data)>0)  { ?>
	...
	<tr>
		...
		<td class="txt_style_td_full fixed freeze_vertical" colspan='2'>Total Asset</td>
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Liability</td>
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Deposit</td>
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Loan Outstanding</td>	
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>HO General Ledger Positive Balance</td>	
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>HO General Ledger Negative Balance</td>	
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Other Asset</td>	
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Other Liability</td>	
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Fixed Asset</td>	
		<td class="txt_style_td_full fixed freeze_vertical" colspan='7'>Off Balance Sheet Exposure</td>
	</tr>
	<tr>
		...
		<td class="txt_style_td_full fixed freeze_vertical">ISS</td>	
		<td class="txt_style_td_full fixed freeze_vertical">Affairs <br>Contra</td>	
		<td class="txt_style_td_full fixed freeze_vertical">Acceptance and Endorsement</td>	
		<td class="txt_style_td_full fixed freeze_vertical">LG</td>	
		<td class="txt_style_td_full fixed freeze_vertical">Irrevocable LC</td>	
		<td class="txt_style_td_full fixed freeze_vertical">Bills for Collection</td>	
		<td class="txt_style_td_full fixed freeze_vertical">Status</td>	
	</tr>	
	<?php
		$co=1;
		foreach($iss_2_0004_data as $row1)
		{
			...
			echo branch_name_resize($row1->BR_Code_BB, $row1->branchname);
			echo $row1->OfficePhone;
			echo "</td>";
			echo "<td align='center'>".$row1->BR_Code_BB."</td>";
			echo "<td align='left'>";
			echo area_name_resize($row1->BR_Code_BB, $row1->znname);
			echo "</td>";
			echo "<td align='left'>";
			if($row1->BR_Code_BB=='120437'){ echo "JBCB";}	else{ echo $row1->dvname; }
			echo "</td>";

			echo "<td align='right'>".number_format($row1->Total_ASset_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_ASset_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Liability_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Liability_ISS, 2)."</td>";
			if($row1->Asset_liability_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Asset_liability_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Asset_liability_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Total_Deposit_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Deposit_ISS, 2)."</td>";
			if($row1->Deposit_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Deposit_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Deposit_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Total_Loan_Outstanding_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Loan_Outstanding_ISS, 2)."</td>";
			if($row1->Loan_check=="Mismatch"){
				echo "<td align='center' class='bg_c_ddd'>".$row1->Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->HOGLPositiveB_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->HOGLPositiveB_ISS, 2)."</td>";
			if($row1->HOGLPositiveB_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->HOGLPositiveB_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->HOGLPositiveB_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->HOGLNegativeB_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->HOGLNBalance_ISS, 2)."</td>";
			if($row1->HOGLNBalance_ISS_check=="Mismatch"){
				echo "<td align='center' class='bg_c_ddd'>".$row1->HOGLNBalance_ISS_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->HOGLNBalance_ISS_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Other_Asset_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Other_ASset_ISS, 2)."</td>";
			if($row1->Other_Asset_check=="Mismatch"){
				echo "<td align='center' class='bg_c_ddd'>".$row1->Other_Asset_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Other_Asset_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Other_Liability_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Other_Liability_ISS, 2)."</td>";
			if($row1->Other_Liability_check=="Mismatch"){
				echo "<td align='center' class='bg_c_ddd'>".$row1->Other_Liability_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Other_Liability_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Fixed_ASset_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Fixed_Asset_ISS, 2)."</td>";
			if($row1->Fixed_Asset_check=="Mismatch"){
				echo "<td align='center' class='bg_c_ddd'>".$row1->Fixed_Asset_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Fixed_Asset_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Off_Balance_Sheet_Exposure_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->contra_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->AcceptanceEndorsement_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->LG_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Irrevocable_LC_Affairs, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Bills_Collection_Affairs, 2)."</td>";
			if($row1->Off_balance_vs_contra_check=="Mismatch"){
				echo "<td align='center' class='bg_c_ddd'>".$row1->Off_balance_vs_contra_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Off_balance_vs_contra_check."</td>";
			}
			echo "</tr>";
			$co++;
		}
	...
	echo form_open('iss/iss_2_004_report_details/1', 'id="iss_2_004_form"');
