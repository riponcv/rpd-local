    ...
    jQuery(document).ready(function() {
        ...
        {
            control_misd_0044_report_form(report_option_selector);
        }
    })
    </script>
       
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Interest Rate Spread (Deposit & Advances)</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('report/misd_0044_report_details','id="misd_0044_search_form"');
	echo '<div id="report_option_div" style="margin-top:50px">';
    echo '<font style="color:brown;font-weight: bold;">Interest Rate Spread For: </font>';
    ...
    echo '<select name="report_option_selector" id="report_option_selector" onchange="control_misd_0044_report_form(this.value)">';
   ...
   <table border="1" style="margin-top: 50px;display: none;" id="search_form_table">
    ...
    <td COLSPAN="3">
    <input type="button" name="deposit" id="deposit" value="Deposit" style="background-color: #FF9900;" onclick="check_search_form_misd_0044(this.value)"/>
    <input type="button" name="advance" id="advance" value="Advance" style="background-color: #FF9900;" onclick="check_search_form_misd_0044(this.value)"/>
    </td>
    </tr>
