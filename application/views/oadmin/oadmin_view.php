    ...
    <div class="row">
        <div class="col-12">
            ...
            <table class="table table-striped" id="">
                <thead>
                    <tr>
                        <th><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" id="refresh" data-target="#Modal_Add"><span class="fa fa-plus"></span>Request your action</a></th>

                    </tr>
                    <tr>
                        <td><a href="<?php echo site_url('oadmin/issdate_view'); ?>">ISS Date</a> </td>
                    </tr>
                    <tr>
                        <td><a href="<?php echo site_url('oadmin/user_view'); ?>">User Management</a> </td>
                    </tr>
                </thead>
            </table>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">Provide Secret key</label>
                    <div class="col-md-10">
                      <input type="text" name="product_code" id="product_code" class="form-control" placeholder="Secret key">
                    </div>
                </div>
                <!--<p style="color:red">Check your email if you get a Secret key then put the code above</p>-->
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="button" type="submit" id="btn_save" class="btn btn-primary">Submit</button>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        setInterval(function(){
            $("#screen").load('<?php echo base_url().'assetsq/'?>/data.php');
        }, 10000);
