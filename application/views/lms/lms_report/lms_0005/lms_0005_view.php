    ...
    jQuery(document).ready(function() {
       ...
       report_option_selector
        ...
        {
            control_lms_0005_report_form(report_option_selector);
        }
...
<div class="container">   
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Follow-up Report</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('lms/lms_0005_report_details','id="lms_0005_search_form"');
    
    echo '<div id="report_option_div" style="margin-top:50px; margin-left:22%">';
    echo '<table>';
    echo '<tr>';
    echo '<td>';
    echo '<font style="color:brown;font-weight: bold;">LIMS Follow-up Report For: </font>';
    echo '</td>';
   ...
   <table border="1" style="margin-top: 50px; display:none" id="search_form_table">
    ...
    <tr id="report_of_br_ao_do_div_box">
        ...
        <td COLSPAN="5"><input type="text" size="37px" name="search_text" id="search_text" value="" onkeyup="fetch_br_ao_do_report_lms(this.value)"/></td>
    </tr>
    ...
    <tr id="report_of_br_ao_do_div">
        <td COLSPAN="5">
            <input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_lms_0005(this.value)"/>
        </td>
    </tr>
    </table> 
