            ...
            <table class="table table-borderless" id="search_form_table_n">
                ...
                <tr>
                    ...
                    <!-- <tr>
                        ...
                        <td>    
                            <div class="form-group ml-5">                       
                            <select name="lawyerInfoN" class="choseSelect" id="lawyerInfo" onchange="">
                                <option value="0">Select </option>
                                <?php 
                                    //foreach($lms_lawer_infos as $lms_lawer_info)
                                    //{
        ...
        <table align="" class="btnTable">
            <tbody>
                <tr>  
                    ...
                    <td></td>              
                    <td>
                    <input type="button" class="btnSave" value="Preview" <?php echo $attribute; ?> style="" onclick="check_lms_basic_form(this.value)" >
                    </td>
