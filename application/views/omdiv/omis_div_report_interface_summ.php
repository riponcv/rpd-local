...
echo '<h2 style="font-size:15px;text-align:center; font-weight:bolder;color:#3311FF"> OMIS Division Summary Report</h2>';
 echo form_open('rpd/omis_div_report_interface_all_summ');
