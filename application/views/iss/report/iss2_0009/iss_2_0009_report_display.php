...
<?php
   ...
   if(isset($iss_2_0009_data) && count($iss_2_0009_data)>0)  { ?>
	...
	<div id="scrolling_table_2" class="scrolly_table scrolling_table_2" style="width:120%; max-height:550px">
		<table border="1">
			<tr>
				...
				<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Interest Suspense Balanc</td>
				<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Staff Loan</td>
				<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total SME Loan Outstanding</td>
				<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Term Loan</td>
				<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Total Loan Outstanding against FDBP</td>		
		</tr>
    ...
    <?php
		$co=1;
		foreach($iss_2_0009_data as $row1)
		{
			...
			echo "</td>";
			echo "<td align='right'>".number_format($row1->Standard_Loan_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Standard_Loan_OMIS, 2)."</td>";
			if($row1->Standard_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Standard_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Standard_Loan_check."</td>";
			}
			
			echo "<td align='right'>".number_format($row1->SMA_Loan_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->SMA_Loan_OMIS, 2)."</td>";
			if($row1->SMA_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->SMA_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->SMA_Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Substandard_Loan_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Substandard_Loan_OMIS, 2)."</td>";
			
			if($row1->Substandard_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Substandard_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Substandard_Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Doubtful_Loan_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Doubtful_Loan_OMIS, 2)."</td>";
			
			if($row1->Doubtful_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Doubtful_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Doubtful_Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Bad_Loan_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Bad_Loan_OMIS, 2)."</td>";
			
			if($row1->Bad_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Bad_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Bad_Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Total_Loan_Outstanding_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Loan_Outstanding_OMIS, 2)."</td>";
			
			if($row1->Total_Loan_Outstanding_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Total_Loan_Outstanding_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Total_Loan_Outstanding_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Total_Int_Sus_Balance_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Total_Int_Sus_Balance_OMIS, 2)."</td>";
			
			if($row1->Intt_Sus_Balance_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Intt_Sus_Balance_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Intt_Sus_Balance_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Staff_Loan_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Staff_Loan_OMIS, 2)."</td>";
			
			if($row1->Staff_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Staff_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Staff_Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->SME_Loan_Outstanding_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->SME_Loan_Outstanding_OMIS, 2)."</td>";
			
			if($row1->SME_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->SME_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->SME_Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Term_Loan_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Term_Loan_OMIS, 2)."</td>";
			
			if($row1->Term_Loan_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->Term_Loan_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->Term_Loan_check."</td>";
			}
			echo "<td align='right'>".number_format($row1->Loan_Outst_against_FDBP_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->Loan_Outst_against_FDBP_OMIS, 2)."</td>";
			
			if($row1->FDBP_OMIS_check=="Mismatch"){
			echo "<td align='center' class='bg_c_ddd'>".$row1->FDBP_OMIS_check."</td>";
			}else{
				echo "<td align='center' class='bg_ddd'>".$row1->FDBP_OMIS_check."</td>";
			}
			echo "</tr>";
			$co++;
		}
