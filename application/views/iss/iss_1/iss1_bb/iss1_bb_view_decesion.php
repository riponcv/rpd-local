<?php
    ...
    {
        echo form_open('iss/iss1_bb_decesion_details','id="iss1_bb_decesion_form"');
    }
	...
	echo "<td COLSPAN='2'>";
    ?>
	<input type="button" name="fetch_iss_data" id="fetch_iss_data" value="Fetch ISS Entry Form" style="background-color: #FF9900;" <?php echo $attribute; ?> onclick="if((jQuery('#fetched_date').val() != '')){jQuery('#iss1_bb_decesion_form').submit();}else{alert('First Select Date and Department..')}"/>
	<?php
	echo "</td></tr>";
	echo "</table>";
	echo form_close();
