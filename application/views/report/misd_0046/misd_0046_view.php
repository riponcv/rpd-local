    ...
    jQuery(document).ready(function() {
        ...
        {
            control_misd_0046_report_form(report_option_selector);
        }
    })
    </script>
       
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Monthly New Loan Statement</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('report/misd_0046_report_details','id="misd_0046_search_form"');
    ...
    echo '<select name="report_option_selector" id="report_option_selector" onchange="control_misd_0046_report_form(this.value)">';
   ...
   <table border="1" style="margin-top: 50px;display: none;" id="search_form_table">
    ...
    <td COLSPAN="3">
    <input type="button" name="summary_report" id="summary_report" value="Summary Report" style="background-color: #FF9900;" onclick="check_search_form_misd_0046(this.value)"/>
    <input type="button" name="detail_report" id="detail_report" value="Detail Report" style="background-color: #FF9900;" onclick="check_search_form_misd_0046(this.value)"/>
    </td>
    </tr>
