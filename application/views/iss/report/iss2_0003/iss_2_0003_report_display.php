...
<?php
   ...
   if(isset($iss_2_0003_data) && count($iss_2_0003_data)>0)  { ?>
	...
	<tr>
		...
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Unreconciled Debit Entries No</td>
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Unreconciled Dr Entries Amount</td>
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Unreconciled Credit Entries No</td>
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Unreconciled Credit Entries Amount</td>
		<td class="txt_style_td_full fixed freeze_vertical" colspan='3'>Last Reconciliation Date</td>	
	</tr>
	<tr>
	...
	foreach($iss_2_0003_data as $row1)
	{
		echo "<tr class='tr_shaded'>";
			...
			echo "</td>";
			echo "<td align='right'>".$row1->Unreconciled_Dr_EntriesNo_ISS."</td>";
			echo "<td align='right'>".$row1->DrNo_OMIS."</td>";
			...
			echo "<td align='right'>".number_format($row1->Unreconciled_Dr_EntriesAmt_ISS, 2)."</td>";
			echo "<td align='right'>".number_format($row1->DrAmt_OMIS, 2)."</td>";
			...
			echo "<td align='right'>".$row1->Unreconciled_Cr_EntriesNo_ISS."</td>";
			echo "<td align='right'>".$row1->CrNo_OMIS."</td>";
			...
			echo "<td align='right'>".$row1->Unreconciled_Cr_EntriesAmt_ISS."</td>";
			echo "<td align='right'>".$row1->CrAmt_OMIS."</td>";
			...
			echo "<td align='right'>".$row1->Last_Reconciliation_Date_ISS."</td>";
			echo "<td align='right'>".$row1->lastReconcileCompletedDate_OMI."</td>";
