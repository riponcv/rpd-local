...
<p>
  ...
  <?php 
   ...
   if((isset($records3_date1) && count($records3_date1)>0) || (isset($records3_date2) && count($records3_date2)>0) || (isset($records3_date3) && count($records3_date3)>0))
   {
	?>
    <table  align="center">
	...
	echo "</tr>";
    echo form_open('rpd/omis_com_graph_details/1');
    if(isset($previous_value) && !empty($previous_value))
    {
    	...
    	echo "<td align='center' COLSPAN='$colspan'>".form_submit('actionbtn', 'Save AS PDF',$attribute)."</td>";
    	echo "</tr>";
