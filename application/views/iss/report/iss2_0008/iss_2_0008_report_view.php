...
function check_search_form_iss2_0007(str)
 {
    if(str !='')
    {
      ...
      if(report_option_selector==1 || report_option_selector==5)
      {
        ...
        if(report_year !='')
        {
            ...
            jQuery('#iss_2_008_search_form').submit();
        }
        else
        {
	...
	<style>
   	...
   	<?php
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Integrated Supervision System(ISS) and PL Items Report</th></tr></table>";
    echo "</table>";

    echo form_open('iss/iss_2_008_report_details','id="iss_2_008_search_form"');
	echo '<div id="report_option_div" style="margin-top:50px;">';
    echo '<font style="color:brown;font-weight: bold;">ISS Form-2 PL Items Report For: </font>';
