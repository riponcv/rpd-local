...
function check_search_form_iss2_0007(str)
 {
    if(str !='')
    {
      ...
      if(report_option_selector==1 || report_option_selector==5)
      {
        ...
        if(report_year !='')
        {
            ...
            jQuery('#iss_2_007_search_form').submit();
        }
        else
        {
	...
	<style>
   	...
   	<?php
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Integrated Supervision System(ISS) and CL 12 Items Cross Report</th></tr></table>";
    echo "</table>";

    echo form_open('iss/iss_2_007_report_details','id="iss_2_007_search_form"');
	echo '<div id="report_option_div" style="margin-top:50px;">';
    echo '<font style="color:brown;font-weight: bold;">ISS Form-2 CL Cross Report For: </font>';
    ...
    <table border="1" style="margin-top: 50px;display: none;" id="search_form_table_n">
		...
		<tr id="report_of_br_ao_do_div">
			<td COLSPAN="6">
			<input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_iss2_0007(this.value)"/>
			</td>
		</tr>		
	</table>
