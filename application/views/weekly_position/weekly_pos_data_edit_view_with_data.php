	...
	if(isset($login_office_status) && $login_office_status ==4)
    {
     echo form_open('weekly_position/weekly_position_edit_save','id="id_weekly_position_edit_form"');   
    }
    else
    {
        echo form_open('');
    ...
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Weekly Position Entry Form</th></tr></table>";
    ...
    echo '<input type="hidden" id="weekly_date" name="weekly_date"  value="'.$weekly_date.'" />';
	
    echo "<div id='flashdata'>";
    echo '<font style="background-color:yellow;font-weight: bold;color: green;">Data For '.$weekly_date.' To Edit</font>'; 
	echo "</div><br/>";
	...
	{
		$set_value=$omis_date_exist;		
	}
	echo "<input type='hidden' name='omis_date_exist' id='omis_date_exist' value='$set_value'/>";
	...
	echo "<td align='centers' width='90'>"."<strong>"."Amount in Taka"."<strong>"."</td>";
	echo "</tr>";
	 $count=1;
	 $z=0;
	 $last=0;
	...
	echo "<td>"." "."</td>";
	echo "<td>"." "."</td>";
	echo "<td><input type='button' id='weekly_position_submit_btn' value='Save Changes' onclick='control_weekly_position_form(this.value)'  $attribute /></td>";
