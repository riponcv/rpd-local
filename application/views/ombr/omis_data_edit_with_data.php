...
<p>
   ...
   echo form_open('rpd/omis_data_insert','id="id_omis_entry_form_edit"');
    
    echo '<input type="hidden" name="datdate" id="datdate" value="'.$selected_date.'" />';
			 ...
			 if($last>0)
				{
					...
					echo '<td>'.'<input type="text" name="totalamt[]" id="totalamt_'.$jjj.'"  readonly="readonly" size="20" value="'.$amt_total[$jjj].'"/>'.'</td>';
					echo '<td>'.'<input type="text" name="totalac[]" id="totalac_'.$jjj.'" readonly="readonly" size="20" value="'.$ac_total[$jjj].'"/>'.'</td>';
					echo "</tr>";
                    $jjj++;
				 }
				$last++;
...
echo '<td>'.'<input type="text" name="amount[]"  onKeyUp="displayOmisText()" value="'.$amount.'" size="20"/>'.'</td>';
	...
	echo '<td>'.'<input type="text" name="totalamt[]" id="totalamt_31"   value="'.$amt_total[$jjj].'" readonly="readonly" size="20"/>'.'</td>';
	echo '<td>'.'<input type="text" name="totalac[]" id="totalac_31" value="'.$ac_total[$jjj].'" readonly="readonly" size="20"/>'.'</td>';
	echo "</tr>";
	...
	echo "<td><input type='button' id='omis_submit_btn' value='Save Changes' onclick='control_omis_form_edit_mode_edit(this.value)' /></td>";
