    ...
    jQuery(document).ready(function() {
        ...
        {
            control_misd_0004_report_form(report_option_selector);
        }
    })
    </script>
       
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Progressive Deposit Mix & ADR Report</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('report/misd_0004_report_details','id="misd_0004_search_form"');
	echo '<div id="report_option_div" style="margin-top:50px">';
    echo '<font style="color:brown;font-weight: bold;">Progressive Deposit Mix & ADR Report For: </font>';
    ...
    echo '<select name="report_option_selector" id="report_option_selector" onchange="control_misd_0004_report_form(this.value)">';
   ...
   <table border="1" style="margin-top: 50px;display: none;" id="search_form_table">
    ...
    <?php
        echo "Year";
        $year_array=array('2015','2014','2013','2012');
    ...
    <td COLSPAN="3">
    <input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_misd_0004(this.value)"/>
    <input type="button" name="save_report_as_pdf" id="save_report_as_pdf" value="Save Report As PDF" style="background-color: #FF9900;" onclick="check_search_form_misd_0004(this.value)"/>
    </td>
    </tr>
