...
<p>
 ...
 $br_count=0;
	...
	*/
	...
	echo "<td width='150' align='left' style='font-size:12px;'>"."<strong>"."Product Category "."<strong>"."</td>";
	echo "<td align='left' style='font-size:12px;'>"."<strong>"."Product "."<strong>"."</td>";
	echo "<td align='center' style='font-size:12px;'>"."<strong>"."Amount "."<strong>"."</td>";
	echo "<td align='center' style='font-size:12px;'>"."<strong>"."No.of A/C "."<strong>"."</td>";
	echo "</tr>";*/
