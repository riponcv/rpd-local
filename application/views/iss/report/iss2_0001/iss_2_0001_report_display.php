...
<p>
  ...
  <?php
   ...
   if(isset($iss_2_item_data) && count($iss_2_item_data)>0)  {
    ...
    <table  align="center">
    <tr align="center"><th>ISS  Form-2 Data Category Report</th></tr>
...
?>
<div class="iss2_data_cat">
	<ul>
		<li>BDT Amount</li>
		<li><input type="radio" name="amt_fig" id="act_val" onclick="check_fig_indication_iss2_data_cat(this.value)" <?php  echo isset($checked_1) ? $checked_1: ' ';?> value="1"> Actual</li>
		<li><input type="radio" name="amt_fig" id="lac_val" onclick="check_fig_indication_iss2_data_cat(this.value)" <?php echo isset($checked_2) ? $checked_2: ' '; ?> value="2"> Lac</li>
		<li><input type="radio" name="amt_fig" id="crr_val" onclick="check_fig_indication_iss2_data_cat(this.value)" <?php echo isset($checked_3) ? $checked_3: ' '; ?> value="3"> Crore (No. is actual)</li>
	</ul>
</div>
    <?php
   ...
   <?php
	...
	if(isset($login_office_status) && $login_office_status == 4)
	{
		...
		echo "<td align='center' >"."<strong>"."COA DESCRIPTION "."<strong>"."</td>";
		...
		echo "<td align='center' style='font-size:9px'>"."<strong>"."Change</br>(Amount in $fig_ind_desc($report_of_date2) - Amount in $fig_ind_desc($report_of_date1))"."<strong>"."</td>";
		echo "<td align='center' style='font-size:8px'>"."<strong>"."Growth(%)</br>((Amount in $fig_ind_desc($report_of_date2) - Amount in $fig_ind_desc($report_of_date1))/Amount in $fig_ind_desc($report_of_date1))*100"."<strong>"."</td>";
	...
	if(isset($login_office_status) && $login_office_status != 4)
	{
		...
		echo "<td align='center' style='font-size:9px'>"."<strong>"."Amountin in $fig_ind_desc<br/>($report_of_date1)"."<strong>"."</td>";
		echo "<td align='center' style='font-size:9px'>"."<strong>"."Amount in $fig_ind_desc<br/>($report_of_date2)"."<strong>"."</td>";
		echo "<td align='center' style='font-size:9px'>"."<strong>"."Change<br/>(Amount in $fig_ind_desc($report_of_date2) - Amount in $fig_ind_desc($report_of_date1))"."<strong>"."</td>";
		echo "<td align='center' style='font-size:8px'>"."<strong>"."Growth(%)</br>((Amount in $fig_ind_desc($report_of_date2) - Amount in $fig_ind_desc($report_of_date1)) / ((Amount in $fig_ind_desc($report_of_date1))))*100"."<strong>"."</td>";
		...
		foreach($iss_2_item_data as $row1)
		{
			echo "<tr>";
				...
				else
				{
					...
					if(isset($fig_indication) && $fig_indication == 3)
					{
					$temp_amt1 = $row1->pre_date/10000000;
					$temp_amt2 = $row1->next_date/10000000;
					echo "<td align='right'>".number_format($temp_amt1, 2)."</td>";
					echo "<td align='right'>".number_format($temp_amt2, 2)."</td>";
					$temp_amt3 = $row1->Diff / 10000000;
					$temp_amt4 = $row1->diff_per;
					...
					elseif (isset($fig_indication) && $fig_indication == 2)
					{
					$temp_amt1 = $row1->pre_date/100000;
					$temp_amt2 = $row1->next_date/100000;
					echo "<td align='right'>".number_format($temp_amt1, 2)."</td>";
					echo "<td align='right'>".number_format($temp_amt2, 2)."</td>";
					$temp_amt3 = $row1->Diff / 100000;
					$temp_amt4 = $row1->diff_per;
	...
	echo form_open('iss/iss_2_001_report_details/1', 'id="iss_2_001_report_details_form"');
	...
	if(isset($previous_value) && !empty($previous_value))
		{
   	    ...
   	    echo "<tr>";
        $attribute='style="background-color: #FF9900;" onclick="check_fig_indication_iss2_data_cat_pdf(this.value)"';
