...
<body>
    ...
    <table  align="center">
    <tr align="center"><th>OMIS Graph</th></tr>
    <tr align="center"><th><?php echo $report_of_office; ?></th></tr>
    <tr align="center">
    <th>
    <?php if(isset($report_of_date3) && $report_of_date3 !=''){ ?>
    OMIS Graph Of: <?php echo isset($report_of_date1)?$report_of_date1:''; echo '  to  '; echo isset($report_of_date3)?$report_of_date3:''; ?>
    <?php }else{ ?>
    OMIS Graph Of: <?php echo isset($report_of_date1)?$report_of_date1:''; echo '  to  '; echo isset($report_of_date2)?$report_of_date2:''; ?>
    <?php } ?>
    </th>
    </tr>
    </table>
...
<div id="g_render"  class="left">
 ...
 <div style="Position:relative; margin: 0 auto; text-align: center; width:448px; height:auto;">
    ...
    $attribute='id="btn_"';
    $attribute1='id="btn1_"';
    echo form_open('rpd/omis_com_graph_details/'.$link_param);
