...
<p>
  ...
  <?php
   ...
   if(isset($iss_2_comp_data) && count($iss_2_comp_data)>1)
   {
    ...
    <table  align="center">
    <tr align="center"><th>ISS Form-2 Customized Comparision Report</th></tr>
...
<div class="iss2_data_cat">
	<ul>
		<li>BDT Amount</li>
		<li><input type="radio" name="amt_fig" id="act_val" onclick="check_fig_indication_iss2_cust_compar(this.value)" <?php  echo isset($checked_1) ? $checked_1: ' ';?> value="1"> Actual</li>
		<li><input type="radio" name="amt_fig" id="lac_val" onclick="check_fig_indication_iss2_cust_compar(this.value)" <?php echo isset($checked_2) ? $checked_2: ' '; ?> value="2"> Lac</li>
		<li><input type="radio" name="amt_fig" id="crr_val" onclick="check_fig_indication_iss2_cust_compar(this.value)" <?php echo isset($checked_3) ? $checked_3: ' '; ?> value="3"> Crore <span>(Number-actual)</span></li>
	</ul>
</div>
    <?php
	...
	echo "<td align='center'>"."<strong>"."SUPERVISION COA ID "."<strong>"."</td>";
	echo "<td align='center' >"."<strong>"."COA DESCRIPTION "."<strong>"."</td>";
	echo "<td align='center' style='font-size:9px'>"."<strong>"."Amount in $fig_ind_desc </br> ($report_of_date1)"."<strong>"."</td>";
	...
	if(isset($login_office_status) && $login_office_status != 1)
	{
		...
		{
			echo "<tr>";
			echo "<td align='center'>".$sl_no."</td>";
			echo "<td align='right'>".$row1->SUPERVISION_COA_ID."</td>";
			echo "<td align='left'>".$row1->cust_coa_desc."</td>";
	...
	if(isset($login_office_status) && $login_office_status == 1)
	{
		...
		foreach($iss_2_comp_data as $row1)
		{
			echo "<tr>";
				...
				if($row1->COA_ID_VALUE == 2)
				{
					//isset($command_office)?$command_office:'';
					if($row1->SUPERVISION_COA_ID == '1010310' || $row1->SUPERVISION_COA_ID=='1011665')
					{
						echo "<td align='right'>".number_format(isset($row1->AMOUNT_BDT1)?$row1->AMOUNT_BDT1:'0', 0, '.', '')."</td>";
	...
	echo form_open('iss/iss2_cust_comp_report_details/1', 'id="iss_item_2_cust_compar_form"');
    if(isset($previous_value) && !empty($previous_value))
    {
        foreach($previous_value as $key=>$val)
        {
   	    ...
   	    echo "<tr>";
        $attribute='style="background-color: #FF9900;" onclick="check_iss_form2_compar_pdf(this.value)"';
