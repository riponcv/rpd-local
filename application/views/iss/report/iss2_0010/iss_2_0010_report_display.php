...
<?php
   ...
   if(isset($iss_2_0010_data) && count($iss_2_0010_data)>0)  { ?>
	...
	<div id="scrolling_table_2" class="scrolly_table scrolling_table_2" style="width:120%; max-height:550px">
		<table border="1">
			<tr>
				...
				<td class="txt_style_td_full fixed freeze_vertical" colspan='4'>SME Loan outstanding</td>
		</tr>

		<tr>
			<td class="txt_style_td_full fixed freeze_vertical">ISS</td>
			<td class="txt_style_td_full fixed freeze_vertical">Online-CL</td>
    ...
    <?php
		$co=1;
		foreach($iss_2_0010_data as $row1)
		{
			if(isset($report_click_btn) && $report_click_btn ==1){
				...
				echo "<td align='right'>".number_format($row1->SME_OLCL, 2)."</td>";
				echo "<td align='right'>".number_format($row1->SME_OMIS, 2)."</td>";
				if($row1->SME_Check=="Mismatch"){
				echo "<td align='center' class='bg_c_ddd'>".$row1->SME_Check."</td>";
				}else{
					echo "<td align='center' class='bg_ddd'>".$row1->SME_Check."</td>";
				}
				echo "</tr>";	
			}else{
