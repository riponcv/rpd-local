    ...
    jQuery(document).ready(function() {
       ...
       report_option_selector
        ...
        {
            control_lms_0006_report_form(report_option_selector);
        }
...
<div class="container">   
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>LIMS Summary Report-2</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('lms/lms_0006_report_details','id="lms_0006_search_form"');
   ...
   <table border="1" style="margin-top: 50px; display:none" id="search_form_table">
    ...
    <tr id="report_of_br_ao_do_div">
        <td COLSPAN="3">
            <input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_lms_0006(this.value)"/>
        </td>
    </tr>
    </table> 
