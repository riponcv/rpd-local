...
?>
    ...
    .btn_line li {
		display:block; margin:40px 0; text-decoration:none; }
    .btn_line #btn_:link, .btn_line #btn_{
		position: relative; font-weight:bold; background-color:#98bf21; text-align:center;
		padding:15px; text-decoration:none; text-transform:uppercase; margin-left: -300px;
		}
    .btn_line #btn_:hover,.btn_line #btn_:active{
		position: relative; background-color:#7A991A; }
    .btn_line #btn1_:link, .btn_line #btn1_{
        position: relative; float:left; font-weight:bold; color:#FFFFFF;
        background-color:#98bf21; text-align:center; padding:15px;
        text-decoration:none; text-transform:uppercase; }
    .btn_line #btn_1:hover,.btn_line #btn1_{
		position: relative; background-color:#7A991A; margin-left: 160px; }

    .btn_line img#arrow_img {
		position:relative; float:left; padding-top:10px;left:30px; }
	</style>
	<table align="center" style="margin: left:100px;">
		<tr align="center"><td><strong> ISS Form-1 (T_PS_M_FI_MONITOR_HO) Report</strong></td></tr>
		<tr align="center"><td> <strong>Item wise Graph Report</strong></td></tr>
  	...
  	<table align="" class="right_align" style="margin-left: 550px; margin-top: -10px; display: block;">
		<tr align="">
			<td>Amount in BDT of</td>

		    <td><input type="radio" name="amt_fig" id="act_val" onclick="check_fig_indication_gr_iss1(this.value)" <?php  echo isset($checked_1) ? $checked_1: ' ';?> value="1"> Actual</td>
  			<td><input type="radio" name="amt_fig" id="lac_val" onclick="check_fig_indication_gr_iss1(this.value)" <?php echo isset($checked_2) ? $checked_2: ' '; ?> value="2"> Lac</td>
  			<td><input type="radio" name="amt_fig" id="crr_val" onclick="check_fig_indication_gr_iss1(this.value)" <?php echo isset($checked_3) ? $checked_3: ' '; ?> value="3"> Crore</td>
		</tr>
  	</table>
	...
	<?php
	 ...
	 if( isset($action_btn) && $action_btn !='') {
	 	echo " Action Yes ";
	 	echo $action_btn;
	 	echo "=Link Param=".$link_param;
	 	echo "=fig indication=".$fig_indication;
	 	echo "=fig indication_p=".$fig_indication_p;
	 }
	 else {
	 	echo " Action No ";
	 	echo $action_btn;
	...
	else
	{
		...
		$attribute='id="btn_"';
		$attribute1='id="btn1_"';
		echo form_open('iss/iss_form_1_itemwise_report_details/'.$link_param, 'id="iss_item_1_dis_gr_form"');
