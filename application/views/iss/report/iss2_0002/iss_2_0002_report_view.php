...
function check_search_form_iss2_0002(str)
 {
    if(str !='')
    {
      ...
      if(report_option_selector==1 || report_option_selector==5)
      {
        ...
        if(report_year !='')
        {
            ...
            jQuery('#iss_2_002_search_form').submit();
        }
        else
        {
	...
	<style>
   	...
   	<?php
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Integrated Supervision System(ISS), OMIS and Affairs Cross  Report</th></tr></table>";
    echo "</table>";

    echo form_open('iss/iss_2_002_report_details','id="iss_2_002_search_form"');
	echo '<div id="report_option_div" style="margin-top:50px;">';
    echo '<font style="color:brown;font-weight: bold;">ISS Form 2 Cross Report For: </font>';
    ...
    <table border="1" style="margin-top: 50px;display: none;" id="search_form_table_n">
		<tr>
			<th COLSPAN="4">
			 <h3 style="color: green;">FILL FORM FOR ISS FORM-2 CROSS REPORT</h3>
		</th>
