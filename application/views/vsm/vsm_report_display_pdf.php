...
<body>
  <?php 
   if(isset($vsm_data_detail) && !empty($vsm_data_detail))
   {
	...
	<tr><td align="left"><strong>As per BRPD Circular letter</strong></td><td align="center"><strong>3</strong></td></tr>
	<tr><td align="left"><strong>Date</strong></td><td align="center"><strong>27.01.2014</strong></td></tr>
	</table>

	<table  align="right" border="1">
	<tr><td align="left"><strong>Last Submission Date</strong></td><td align="center"><strong><?php echo date('d.m.y',strtotime($vsm_data_detail['vsm_data_sb_dt']));?></strong></td></tr>
	<tr><td align="left"><strong>Printing Date</strong></td><td align="center"><strong><?php echo date('d.m.y');?></strong></td></tr>
	</table>
   ...
   <table  align="center">
	...
	<br/>
        <table border="2" width="800" align="center" id="t1">
        
        <!-- Structural Security Start -->
    	<tr><th colspan="4" style="font-weight: bold;text-align: center; font-size:18px">Structural Security</th></tr>
    	
        <tr>
        <td width="20">1.1</td>
        <td width="470">Steel frame has been given around vault space</td>
        <?php
        $steel_frame_YN='';
        ...
        <tr>
            ...
            <td style="text-align: left;">
            To : <?php echo $rent_agreement_dt_to; ?>
            </td>
        </tr>
    	...
    	<tr><th colspan="4" style="font-weight: bold;text-align: center; font-size:18px">Technological  Security</th></tr>
    	...
    	<!-- Bima Security Start -->
    	<tr><th colspan="4" style="font-weight: bold;text-align: center; font-size:18px">Bima Security</th></tr>
    	...
    	<tr><th colspan="4"  style="font-weight: bold;text-align: center; font-size:18px">Cash Related Information </th></tr>
		...
		?>
        <td align="center"><?php echo $VS_checked_CO_date; ?></td>
		<?php
		...
		?>
		<td style="text-align: left;"><?php echo $VS_checked_CO_name.','.$VS_checked_CO_dsg; ?></td>
		</tr>
	...
	?>
	<span align="left" >The above information is checked and approved by us.</span>
	<br/><br/><br/><br/><br/>
