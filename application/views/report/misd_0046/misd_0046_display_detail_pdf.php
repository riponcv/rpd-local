...
<td align="center"><?php echo isset($row['DISBURSEMENT_DATE'])?date('Y-m-d',strtotime($row['DISBURSEMENT_DATE'])):''; ?></td>
<td align="center"><?php echo isset($row['SANCTION_DATE'])?date('Y-m-d',strtotime($row['SANCTION_DATE'])):''; ?></td>
</tr>
<?php } ?>
