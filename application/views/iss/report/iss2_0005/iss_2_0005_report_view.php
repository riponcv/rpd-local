...
function check_search_form_iss2_0002(str)
 {
    if(str !='')
    {
      ...
      if(report_option_selector==1 || report_option_selector==5)
      {
        ...
        if(report_year !='')
        {
            ...
            jQuery('#iss_2_005_search_form').submit();
        }
        else
        {
	...
	<style>
   	...
   	<?php
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Integrated Supervision System(ISS) 10 Items Report</th></tr></table>";
    echo "</table>";

    echo form_open('iss/iss_2_005_report_details','id="iss_2_005_search_form"');
