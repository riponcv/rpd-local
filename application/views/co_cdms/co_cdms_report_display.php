...
<table id="my_table_CDMS" BORDER=2 CELLPADDING=4 style="width: 100px;">
<tr>
    <th ROWSPAN=2 BGCOLOR="#99CCFF">No of Employee</th>
    <th ROWSPAN=2 BGCOLOR="#99CCFF">A/C Type</th>
	<th colspan=4 BGCOLOR="#99CCFF">Amount</th>
	<th colspan=4 BGCOLOR="#99CCFF">Account</th>
 </tr>
 ...
 if(isset($records) && count($records)>0)
{
    ...
    ?>
    <tr bgcolor="#99CCFF" style="text-align: right;">
...
<tr BGCOLOR="#99CCFF"><th colspan="3">Acheivement</th></tr>
...
<div style="position:relative;float:left;padding-top: 10px;">
<table border="2" cellpadding="4">
<tr BGCOLOR="#99CCFF"><th colspan="11">Yearly Target</th></tr>
...
<table border="2" cellpadding="4">
<tr BGCOLOR="#99CCFF"><th colspan="6">Acheivement Grade</th></tr>
...
<?php 
    ...
    echo form_open('rpd/co_cdms_report_details/1');
