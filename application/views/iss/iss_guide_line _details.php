...
<body>
	...
	<?php
		//echo "<pre>";
		//print_r($query_9item_data);
		//die();
		echo  "<h2 style='color:#000000'>Integrated Supervision System Guide Line</h2>";?>
		<?php if( isset($query_9item_data) && !empty($query_9item_data)) { ?>
		<div style="background: #ddd none repeat scroll 0 0; width: 100%;">
		<?php foreach( $query_9item_data as $items){ ?>
		<table>
			<tr>
				<td>Branch Name:</td>
				<td><?php echo $items->branchname; ?></td>
			</tr>
			<tr>
				<td>Branch Code:</td>
				<td><?php echo $items->brcode.' ('.'BB Code-'.$items->bbbrcode.')'; ?></td>
			</tr>
		</table>
		<?php } ?>
		<table border="1">
			<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
				<td>SL</td>
				<td>GENERATED ISS ITEMS (From Affairs)</td>
				<td>Amount in BDT</td>
			</tr>
			<?php foreach( $query_9item_data as $items){ ?>
				<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
					<td><?php echo "1"; ?></td>
					<td><?php echo 'Total Asset'; ?></td>
					<td><?php echo $items->Total_Asset; ?></td>
				</tr>
				<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
					<td><?php echo "2"; ?></td>
					<td><?php echo 'Total Liability'; ?></td>
					<td><?php echo $items->Total_Liability; ?></td>
				</tr>
				<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
					<td><?php echo "3"; ?></td>
					<td><?php echo 'Total Deposit'; ?></td>
					<td><?php echo $items->Total_Deposit; ?></td>
				</tr>
				<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
					<td><?php echo "4"; ?></td>
					<td><?php echo 'Total Loan Outstanding'; ?></td>
					<td><?php echo $items->Total_Loan_Outstanding; ?></td>
				</tr>
				<tr>
					<td><?php echo "5"; ?></td>
					<td><?php echo 'Head Office General Ledger Positive Balance'; ?></td>
					<td><?php echo $items->HOGL_Pos_bal; ?></td>
				</tr>
				<tr>
					<td><?php echo "6"; ?></td>
					<td><?php echo 'Head Office General Ledger Negative Balance'; ?></td>
					<td><?php echo $items->HOGL_Neg_bal; ?></td>
				</tr>
				<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
					<td><?php echo "7"; ?></td>
					<td><?php echo 'Total Other Asset'; ?></td>
					<td><?php echo $items->Total_Other_Asset; ?></td>
				</tr>
				<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
					<td><?php echo "8"; ?></td>
					<td><?php echo 'Total Other Liability'; ?></td>
					<td><?php echo $items->Total_Other_Liability; ?></td>
				</tr>
				<tr style="color:black;font-weight:700;font-size:16px; text-align:center">
					<td><?php echo "9"; ?></td>
					<td><?php echo 'Total Fixed Asset'; ?></td>
					<td><?php echo $items->Total_Fixed_Asset; ?></td>
				</tr>	
				<?php 
		...
		<?php } 
			 ...
			 echo '<span style="background:red; font-size:18px; color:white">No Information found</span>';
		 }
		?>
		</div>
		<?php
		...
		$msg.='<tr style="font-weight:500;font-size:14px;"><td>5</td><td>Head Office General Ledger Positive Balance (after netting off)</td><td><div class="iss_total_hoglpb"><span class="span_total_hoglpb"></span></div></td></tr>';
		$msg.='<tr style="font-weight:500;font-size:14px;"><td>6</td><td>Head Office General Ledger Negative Balance (after netting off)</td><td><div class="iss_total_hoglnb"><span class="span_total_hoglnb"></span></div></td></tr>';
