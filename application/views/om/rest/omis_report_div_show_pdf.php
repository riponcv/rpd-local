...
table td{margin:0;padding:0;background-color:#EBEBEB;padding:0px;}
table th{margin:0;padding:0;border:1px solid #D2D2D2;padding:0px;}
</style>
</head>
<body>
<p>
  ...
  //echo form_open('rpd/omis_admin_div_report_show_form/true');
  //$date_var=$date1;
 // echo "<input type='hidden' name='datdate' size='15' value='$date_var'/>";
	...
	echo "<tr>";
	echo "<th>"."<strong>"."Ser. No "."<strong>"."</th>";
	echo "<th>"."<strong>"."Product Category "."<strong>"."</th>";
	echo "<th>"."<strong>"."Product "."<strong>"."</th>";
	echo "<th>"."<strong>"."Amount "."<strong>"."</th>";
	echo "<th>"."<strong>"."No.of A/C "."<strong>"."</th>";
	echo "</tr>";
	$data_ac = array();
	$data_amt = array();
	$ac_count=0;
