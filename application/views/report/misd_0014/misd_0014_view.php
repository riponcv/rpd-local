    ...
    jQuery(document).ready(function() {
        ...
        {
            control_misd_0014_report_form(report_option_selector);
        }
    })
    </script>
       
    <?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Branch Specification Report</th></tr></table>";
    echo "</table>";  
    ...
    <?php
    echo form_open('report/misd_0014_report_details','id="misd_0014_search_form"');
	echo '<div id="report_option_div" style="margin-top:50px">';
    echo '<font style="color:brown;font-weight: bold;">Branch Specification For: </font>';
    ...
    echo '<select name="report_option_selector" id="report_option_selector" onchange="control_misd_0014_report_form(this.value)">';
   ...
   <table border="1" style="margin-top: 50px;display: none;" id="search_form_table">
    ...
    <td>Opening Date :</td>
    <td>
    <input type="text" readonly="readonly" name="range1_opndate" id="datepicker" size="15" style="background-color: #FFFFCC ;" value="<?php echo isset($_POST['range1_opndate'])?$_POST['range1_opndate']:'01-Jan-1900'; ?>"/>
    <span >to</span>
    <input type="text" readonly="readonly" name="range2_opndate" id="datepicker1" size="15" style="background-color: #FFFFCC ;" value="<?php echo isset($_POST['range2_opndate'])?$_POST['range2_opndate']:date('d-M-Y'); ?>"/>
    </td>
    </tr>
    ...
    <td COLSPAN="3">
    <input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_misd_0014(this.value)"/>
    <input type="button" name="save_report_as_pdf" id="save_report_as_pdf" value="Save Report As PDF" style="background-color: #FF9900;" onclick="check_search_form_misd_0014(this.value)"/>
    </td>
    </tr>
