...
<table border="1" align="right" style="border: thin;margin-top: -80px;border-collapse:collapse;" id="t1">
  <tr>
    ...
    <td width="140"><?php echo isset($report_details->report_id)?$report_details->report_id."A":''; ?></td>
  </tr>
  <tr>
...
<td align="center" style="font-weight: bold;"><?php echo $result_array[$m]['month_name'].$txtR; ?></td>
 <?php } ?>
</tr>
