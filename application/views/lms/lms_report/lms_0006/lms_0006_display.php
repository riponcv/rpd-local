...
<table align="center">
  <tr>
    <td align="center" style="font-size:20px;">Summary Report-2</td>
  </tr>
  <tr>
...
<table border="1">
    ...
    <th style="text-align:center" colspan="2">Writ Petition</th>
    <th style="text-align:center" colspan="2">Appeal and Review Suit</th>
		<th style="text-align:center" colspan="2">Insolvancy Suit</th>
    <th style="text-align:center" colspan="2">Administrative</th>
    <th style="text-align:center" colspan="2">Civil Suit</th>
    <th style="text-align:center" colspan="2">Misc. Suit</th>
    <th style="text-align:center" colspan="2">PDR Act</th>
  ...
  <?php 
    ...
    <td align="right"><?php echo isset($row['report_val']['appeal_review_suitNo'])?$row['report_val']['appeal_review_suitNo']:''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['appeal_review_suitAmt'])?number_format($row['report_val']['appeal_review_suitAmt'], 2):''; ?></td>
    ...
    <td align="right"><?php echo isset($row['report_val']['administrative_suitNo'])?$row['report_val']['administrative_suitNo']:''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['administrative_suitAmt'])?number_format($row['report_val']['administrative_suitAmt'], 2):''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['civil_suitNo'])?$row['report_val']['civil_suitNo']:''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['civil_suitAmt'])?number_format($row['report_val']['civil_suitAmt'], 2):''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['misc_suitNo'])?$row['report_val']['misc_suitNo']:''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['misc_suitAmt'])?number_format($row['report_val']['misc_suitAmt'], 2):''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['pdr_suitNo'])?$row['report_val']['pdr_suitNo']:''; ?></td>
    <td align="right"><?php echo isset($row['report_val']['pdr_suitAmt'])?number_format($row['report_val']['pdr_suitAmt'], 2):''; ?></td>
