    ...
    jQuery(document).ready(function() {
   	...
   	<?php 
    echo "<table align =center id=\"tbldesgTarget\"><tr><th>Integrated Supervision System Report</th></tr></table>";
    echo "</table>";  
    ...
    echo form_open('iss/iss_report_details','id="iss_search_form"');
    ...
    <td COLSPAN="2">
    <input type="button" name="view_report" id="view_report" value="View Report" style="background-color: #FF9900;" onclick="check_search_form_iss(this.value)"/>
