...
?>
    ...
    <?php 
        $attributesForm = array('name' => 'lmsBasicWrittenoffForm', 'id'=>'lms_basic_search_writtenoff_info_form');
        echo form_open_multipart('lms/lms_writeoff_entry_details_view', $attributesForm);
    ?>
    <div class="header-info text-center">
       <h4>Search for Written-Off Entry</h4>
    </div>
    <table class="search_tbl">    
        <tr>
            <td><label for="tracNoS">Trac No.</label></td>
            <td>
            <div class="form-group">
            <select name="tracNoSN" class="choseSelect tracNoC" id="tracNoS" style="">
            ...
            <div class="error" id="tracNoSEID" tabindex="-1"></div>
            </div>
            </td>
            ...
            <td>
            <div class="form-group">
                <input type="button" class="btn btnSave" value="Search" <?php echo $attribute; ?> style="background-color: #bb33ff; padding: 0px 18px;" onclick="lms_written_off_view_search(this.value)"/>            
            </div>  
            </td>                    
        </tr>
    </table>
    ...
    <table class="table table-bordered" border="1" id="mydata">
        ...
        <?php foreach($lmseditDatas as $lmseditData) {?>
            <tr>
                <td><?php 
                    echo anchor('lms/lms_writeoff_entry_details_view/'.$lmseditData->lb_tran_no, $lmseditData->lb_tran_no, 'title="Edit"');
                ?>
