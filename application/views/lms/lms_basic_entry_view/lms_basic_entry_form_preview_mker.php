...
?>
    ...
    <?php 
        $attributesForm = array('name' => 'lmsBasicMkerPrv', 'id'=>'lms_basic_entry_prv_form');
        echo form_open('lms/lms_basic_entry_preview_mker_action', $attributesForm);
    ?>
        <div class="row">
            <table class="table table-borderless" id="search_form_table_n">
                                    ...
                                    if($court_type[0] === strval(5)){
                                            if($court_type == '51'){
                                                foreach($lms_thana as $lms_th){ 
                                                    //if((int)$lms_th->dtcode == intval(substr($locationOfCourtN, 3, 2))){
                                                        if((int)$lms_th->dtcode == intval($districtN)){
                                                        $cDist = $lms_th->dtname;
                                                        $cDistC = $lms_th->dtcode;
                                                    }
                                                }
                                            ...
                                            if($court_type == '52'){
                                                foreach($lms_thana as $lms_th){ 
                                                    ...
                                                    if((int)$lms_th->thcode == intval($thanaN)){
                                                        $cUpa = $lms_th->thname;
                                                        $cUpaC = $lms_th->thcode;
                                                    }
                                                }
                ...
                <tr>
                        ...
                        <td>
                            <div class ="form-group unConDis ml-5">
                                ...
                                ?>
                                <input type="hidden" value="<?php echo isset($cDistC)?$cDistC:''; ?>" class="form-control" id="district" name="districtN">
                            </div>
                        </td>
                        <td>
                            <div class ="form-group unConTh ml-5">
                                ...
                                ?>
                                <input type="hidden" value="<?php echo isset($cUpaC)?$cUpaC:''; ?>" class="form-control" id="thana" name="thanaN">
                            </div>
                        </td>
                    </tr>
                    <tr>
                ...
                <tr>
                    ...
                    <td>
                            <div class="form-group ta-r">
                                <label for="authenBy"><p style="font-size: 12px">Above all information is correct <br> checked by Manager/Dealing Officer BID</p></label>
                            </div>
                        </td>
                        <td colspan="3">
                            <div class="form-group ml-5">
                            <p><input type="textbox" id="authMBID" name="authMBIDN" value="">
                                <input type="checkbox" id="authenBy" name="authenBy" value="1" onclick="lms_basic_mker_auth_check(this.value)">
                                Same as Manager/Dealing Officer BID</p>
                            </div>
                        </td>         
                    </tr>                         
                </tbody>
        ...
        <table align="" class="btnTable">
            <tbody>
                <tr>  
                    ...
                    <td></td>              
                    <td>
                        <input type="button" class="btnSave" name="prvBtn" value="Previous" <?php echo $attribute; ?> onclick="check_lms_basic_mker_pvr_form(this.value)" >
                    </td>
                    <td>
                        <input type="button" class="btnSave" name="prvBtn" value="Save" <?php echo $attribute; ?> onclick="check_lms_basic_mker_pvr_form(this.value)" >
                    </td>
                    <td>
                        <input type="hidden" id="mkerPrvBtnID" name="mkerPrvBtn" value=""  >            
                    </td>
                </tr>  
            </tbody>
        </table>
