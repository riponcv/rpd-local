...
<br />
<table style="margin-left: 734px;"><tr><td>Amount in Crore</td></tr></table>
<table border="1" style="border-collapse:collapse;" id="t1" align="center">
	...
	<tr>
		...
		<td align="right"><?php if(isset($total_resch_date1)&& isset($total_resch_date2)){echo round(($total_resch_date2-$total_resch_date1),2);}else{echo '-';}?><
	</tr>
	<tr>
		<td>2</td>
