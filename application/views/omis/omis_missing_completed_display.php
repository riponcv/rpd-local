...
<table>
<tr><th style="font-size: larger;">Overview MIS Report</th></tr>
<tr><th><?php echo $report_of_office; ?></th></tr>
<tr><th>Report Of : <?php echo isset($report_of_date)?$report_of_date:''; ?></th></tr>
<?php 
$style='';
$text='';
if(isset($report_click_btn) && $report_click_btn=='Missing List')
{
    $style='style="background-color: red;"';
    $text='Missing Branch List';
}
if(isset($report_click_btn) && $report_click_btn=='Completed List')
{
