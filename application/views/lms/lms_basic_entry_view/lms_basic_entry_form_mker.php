...
window.onload = function() {
    ...
    let unConSenL = document.getElementsByClassName('unConSen')[0];
    unConSenL.style.display= "none";
    let unConSenT = document.getElementsByClassName('unConSen')[1];
    unConSenT.style.display= "none";
}
