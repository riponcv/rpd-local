    ...
    {
        echo form_open('iss/iss1_bb_form_details','id="iss1_bb_view_form"');
    }
	...
	echo "<td COLSPAN='2'>";
    ?>
	<input type="button" name="fetch_iss_data" id="fetch_iss_data" value="Fetch ISS Entry Form" style="background-color: #FF9900;" <?php echo $attribute; ?> onclick="if((jQuery('#fetched_date').val() != '')){jQuery('#iss1_bb_view_form').submit();;}else{alert('First Select Date and Department..')}"/>
