...
<div class="iss2_data_cat">
	<ul>
		<li>BDT Amount</li>
		<li><input type="radio" name="amt_fig" id="act_val" onclick="check_fig_indication_iss2_compar(this.value)" <?php  echo isset($checked_1) ? $checked_1: ' ';?> value="1"> Actual</li>
		<li><input type="radio" name="amt_fig" id="lac_val" onclick="check_fig_indication_iss2_compar(this.value)" <?php echo isset($checked_2) ? $checked_2: ' '; ?> value="2"> Lac</li>
		<li><input type="radio" name="amt_fig" id="crr_val" onclick="check_fig_indication_iss2_compar(this.value)" <?php echo isset($checked_3) ? $checked_3: ' '; ?> value="3"> Crore <span>(Number-actual)</span></li>
	</ul>
</div>
    <?php
	...
	echo form_open('iss/iss_comparision_report_details/1', 'id="iss_item_2_compar_form"');
