...
/*-----------Branch Letter report start------------------*/
 ...
 /*-----------Branch Letter report end------------------*/
  ...
  function check_iss1_bb_decesion_data_entry(str_val)
  {
    alert("Submit");
	jQuery('#iss1_bb_decesion_entry_form').submit();
  }
...
function check_fig_indication_iss2_con_rep(str)
{
    ...
    if(str !='')
    {
		...
		$("#fig_indication_post").val(r);
		$("#pdf_btn_inst").val(0);
        $('#iss_form_2_continous_report_details').submit();
    }
}
   ...
   if(str !='')
    {
		...
		if(str=='Save AS PDF')
		{
			report_pdf_btn = 1;
			jQuery('#pdf_btn_inst').val(report_pdf_btn);
			jQuery('#iss_form_2_continous_report_details').submit();
		}
    }
}
