...
<script type="text/javascript">
    jQuery(document).ready( function() {
        $("#search_branch_by_text").keyup(function(){
			var searchText=jQuery('#search_branch_by_text').val();
		 	jQuery.ajax({
				url: "<?php echo base_url();?>index.php/rpd/search_branch_by_text",
				type: "POST",
...
<?php
	...
	echo '<h2 style="font-size:15px;text-align:center; font-weight:bolder;color:#3311FF"> OMIS Branch Summary Report</h2>';
 echo form_open('rpd/omis_br_report_interface_all_summ');
  //echo form_open('rpd/delete_om_data');
	...
	echo "</td>";
	echo "<td>";
	echo "<input type='text' name='br_code' size='6' />";
	echo "</td>";*/
	?>
	<td>
	Search Branch Name
	...
	<td>
	<input type="text"  name="search_branch_by_text" id="search_branch_by_text" />
	</td>
