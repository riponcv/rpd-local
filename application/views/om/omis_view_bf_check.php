			 ...
			 if($last>0)
				{
					...
					echo '<td>'.'<input type="text" name="totalamt[]" value="'.$amt_total[$jjj].'" id="totalamt"  readonly="readonly" size="15"/>'.'</td>';
					echo '<td>'.'<input type="text" name="totalac[]" value="'.$ac_total[$jjj].'" id="totalac" readonly="readonly" size="8"/>'.'</td>';
					echo "</tr>";
				 	$jjj++;
				 }
				$last++;
...
echo '<td>'.'<input type="text" name="amount[]"  onKeyUp="displayOmisText()" value="'.$amount.'" size="15"/>'.'</td>';
	...
	echo "<td>"." "."</td>";
	echo "<td align='left'>"."<strong>"."Total "."<strong>"."</td>";
	echo '<td>'.'<input type="text" name="totalamt[]" id="totalamt"   value="'.$amt_total[$jjj].'" readonly="readonly" size="15"/>'.'</td>';
	echo '<td>'.'<input type="text" name="totalac[]" id="totalac" value="'.$ac_total[$jjj].'" readonly="readonly" size="8"/>'.'</td>';
	echo "</tr>";
